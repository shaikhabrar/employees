          ...
          <div className="col-lg-6">
            <div className="card2 card border-0 px-4 py-5">
              ...
              <div className="row px-3">
                ...
                <input type="password" name="password" placeholder="Enter Password (Min 8 digits)" 
                value={password}
              ...
              <div className="row mb-4 px-3">
                <small className="font-weight-bold">Already have an account? <Link to="/Login">Login</Link></small>
              </div>
            </div>
          </div>
        </div>
